 ...
 */
@Getter
public final class ScraperSearchRequest implements JobSearchRequest {
  ...
  private ScraperSearchRequest(Builder builder) {
  ...
  public static final class Builder implements ConversationBuilder {
    ...
    private Builder(ScraperSearchRequest source) {
    ...
    @Override
    public ScraperSearchRequest build() {
      return new ScraperSearchRequest(this);
    }
  }
}
