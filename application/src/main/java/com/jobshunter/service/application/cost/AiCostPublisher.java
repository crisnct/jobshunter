...
/**
 * Service for publishing AI API cost events.
 * Centralizes cost event publishing logic that was previously duplicated across AI clients.
 */
@Service
...
public class AiCostPublisher {
   ...
   */
  public void publishGpt(Long orderId, AiModelEntity model, Usage usage) {
    if (usage != null) {
      eventPublisher.publishEvent(new AiRequestCostEvent(this, orderId, model,
   ...
   */
  public void publishGemini(Long orderId, AiModelEntity model, UsageMetadata usage) {
    if (usage != null) {
      eventPublisher.publishEvent(new AiRequestCostEvent(this, orderId, model,
   ...
   */
  public void publishGrok(Long orderId, AiModelEntity model,
      com.jobshunter.dto.grokResponse.Usage usage) {
    if (usage != null) {
      eventPublisher.publishEvent(new AiRequestCostEvent(this, orderId, model,
