...
This diagram shows the complete architecture of the `hunting` package, including class inheritance
hierarchy, relationships, dependencies, and data flow.
...
- **HuntingOrchestrator** depends on:
    - All concrete hunting implementations (GptJobHunting, GrokJobHunting, GeminiJobHunting,
      SerpJobHunting)
