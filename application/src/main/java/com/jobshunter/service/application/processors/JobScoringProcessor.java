...
@Slf4j
@Service
public final class JobScoringProcessor implements JobProcessor {

  //public static final EngineSelection ENGINE_SELECTION = new EngineSelection(EngineType.GPT, "gpt-5.1-2025-11-13");
  //public static final EngineSelection ENGINE_SELECTION =  new EngineSelection(EngineType.GROK, "grok-4-fast-reasoning");
  public static final EngineSelection ENGINE_SELECTION = new EngineSelection(EngineType.GEMINI, "gemini-2.5-flash");
