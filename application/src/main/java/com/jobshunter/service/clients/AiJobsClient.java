...
import com.jobshunter.service.clients.scraper.ScraperJobSearchImpl;
...
import com.jobshunter.service.testdata.FakeScraperClient;
...
public sealed interface AiJobsClient<R extends JobSearchRequest>
    permits GeminiV1JobSearchImpl, GptV1JobSearchImpl, GrokV1JobSearchImpl, ScraperJobSearchImpl, SerpClientImpl, FakeGeminiClient, FakeGptClient,
    FakeGrokClient, FakeScraperClient, FakeSerpClient {
